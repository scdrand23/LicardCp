...
class CamEncode(nn.Module):  # 提取图像特征进行图像编码
    ...
    def forward(self, x):
        ...
        x_img_ = x[:,:3:,:,:]
        # print("Image input shape:", x_img_.shape)
